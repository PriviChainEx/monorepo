...
// Make sure to provide your actual API key here.
  const SINDRI_API_KEY = process.env.SINDRI_API_KEY || "sindri-0uIc9CrvilTYWmOe2lpXwdXOOc6QJ5IG-p6YX";
...
// Generate a new proof and poll for completion.
  const proofInput = `current_balance = 100
new_balance = 105
receiver_chainID = 5
token_value = 5
intended_receiver_chainID = 5`;
